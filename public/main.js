document.addEventListener('DOMContentLoaded', () => {
    ...
    async function createRequisition(institutionId) {
        try {
            ...
            const redirectUrl = `${window.location.origin}?ref=`;
            ...
            // Store requisition ID in session storage for when we return
    ...
    async function handleBankCallback(ref) {
        try {
            ...
            // Get requisition ID from session storage
